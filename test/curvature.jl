@testset "Curvature" begin
    ...
    @testset "Edge curvature" begin
        ...
        @test get_edge_curvature_distribution(G) == Dict(
            Edge(1, 2) => 2,
            Edge(3, 4) => 0,
            Edge(4, 5) => -1,
            Edge(4, 6) => -1,
        ...
        @test get_edge_curvature_distribution(W) ==  Dict(
    ...
    @testset "Node curvature" begin
        @test get_node_curvature_distribution(G) == Dict(
            1 => 2.0, 2 => 2.0, 3 => 0.0, 4 => -2.0, 5 => -1.0, 6 => -1.0
            )
    end
end